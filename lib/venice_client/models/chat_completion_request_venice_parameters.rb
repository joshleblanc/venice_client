...
module VeniceClient
  ...
  class ChatCompletionRequestVeniceParameters
    ...
    def hash
      [character_slug, strip_thinking_response, disable_thinking, enable_web_search, enable_web_scraping, enable_web_citations, include_search_results_in_stream, return_search_results_as_documents, include_venice_system_prompt].hash
    end
