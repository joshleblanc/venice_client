...
module VeniceClient
  # The system message is a special message that provides context to the model. It is not part of the conversation and is not visible to the user.
  class SystemMessage
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `VeniceClient::SystemMessage` initialize method"
      end
    ...
    def valid?
      ...
      role_validator = EnumAttributeValidator.new('String', ["system"])
