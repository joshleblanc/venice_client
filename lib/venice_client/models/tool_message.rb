  ...
  class ToolMessage
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `VeniceClient::ToolMessage` initialize method"
      end
    ...
    def list_invalid_properties
      ...
      if @tool_call_id.nil?
        invalid_properties.push('invalid value for "tool_call_id", tool_call_id cannot be nil.')
      end
    ...
    def valid?
      ...
      role_validator = EnumAttributeValidator.new('String', ["tool"])
      return false unless role_validator.valid?(@role)
      return false if @tool_call_id.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] tool_call_id Value to be assigned
    def tool_call_id=(tool_call_id)
      if tool_call_id.nil?
        fail ArgumentError, 'tool_call_id cannot be nil'
      end
    ...
    def hash
      [content, name, reasoning_content, role, tool_call_id, tool_calls].hash
    end
