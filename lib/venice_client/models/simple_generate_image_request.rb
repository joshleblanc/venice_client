...
module VeniceClient
  class SimpleGenerateImageRequest
    ...
    def background=(background)
      validator = EnumAttributeValidator.new('String', ["transparent", "opaque", "auto"])
    ...
    def moderation=(moderation)
      validator = EnumAttributeValidator.new('String', ["low", "auto"])
    ...
    def n=(n)
      if !n.nil? && n > 1
        fail ArgumentError, 'invalid value for "n", must be smaller than or equal to 1.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] output_compression Value to be assigned
    def output_compression=(output_compression)
      if !output_compression.nil? && output_compression > 100
        fail ArgumentError, 'invalid value for "output_compression", must be smaller than or equal to 100.'
      end

      if !output_compression.nil? && output_compression < 0
        fail ArgumentError, 'invalid value for "output_compression", must be greater than or equal to 0.'
      end
    ...
    def quality=(quality)
      validator = EnumAttributeValidator.new('String', ["auto", "high", "medium", "low", "hd", "standard"])
    ...
    def response_format=(response_format)
      validator = EnumAttributeValidator.new('String', ["b64_json", "url"])
    ...
    def size=(size)
      validator = EnumAttributeValidator.new('String', ["auto", "256x256", "512x512", "1024x1024", "1536x1024", "1024x1536", "1792x1024", "1024x1792"])
