...
module VeniceClient
  class GetBillingUsage200ResponseDataInner
    ...
    # Custom attribute writer method with validation
    # @param [Object] price_per_unit_usd Value to be assigned
    def price_per_unit_usd=(price_per_unit_usd)
      if price_per_unit_usd.nil?
        fail ArgumentError, 'price_per_unit_usd cannot be nil'
      end
