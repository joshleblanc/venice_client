...
module VeniceClient
  ...
  class ModelResponse
    ...
    def self.openapi_types
      {
        :'created' => :'Float',
        :'id' => :'String',
        :'model_spec' => :'ModelResponseModelSpec',
        :'object' => :'String',
        :'owned_by' => :'String',
        :'type' => :'String'
      }
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `VeniceClient::ModelResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] model_spec Value to be assigned
    def model_spec=(model_spec)
      if model_spec.nil?
        fail ArgumentError, 'model_spec cannot be nil'
      end
    ...
    def owned_by=(owned_by)
      validator = EnumAttributeValidator.new('String', ["venice.ai"])
