...
# Unit tests for SwaggerClient::AnyOfChatCompletionRequestToolChoice
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AnyOfChatCompletionRequestToolChoice' do
  before do
    # run before each test
    @instance = SwaggerClient::AnyOfChatCompletionRequestToolChoice.new
  end
  ...
  describe 'test an instance of AnyOfChatCompletionRequestToolChoice' do
    it 'should create an instance of AnyOfChatCompletionRequestToolChoice' do
      expect(@instance).to be_instance_of(SwaggerClient::AnyOfChatCompletionRequestToolChoice)
    end
  end
end
