...
# Unit tests for SwaggerClient::ChatCompletionRequestVeniceParameters
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChatCompletionRequestVeniceParameters' do
  before do
    # run before each test
    @instance = SwaggerClient::ChatCompletionRequestVeniceParameters.new
  end
  ...
  describe 'test an instance of ChatCompletionRequestVeniceParameters' do
    it 'should create an instance of ChatCompletionRequestVeniceParameters' do
      expect(@instance).to be_instance_of(SwaggerClient::ChatCompletionRequestVeniceParameters)
    end
  end
