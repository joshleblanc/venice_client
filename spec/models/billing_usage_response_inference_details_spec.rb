...
# Unit tests for SwaggerClient::BillingUsageResponseInferenceDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BillingUsageResponseInferenceDetails' do
  before do
    # run before each test
    @instance = SwaggerClient::BillingUsageResponseInferenceDetails.new
  end
  ...
  describe 'test an instance of BillingUsageResponseInferenceDetails' do
    it 'should create an instance of BillingUsageResponseInferenceDetails' do
      expect(@instance).to be_instance_of(SwaggerClient::BillingUsageResponseInferenceDetails)
    end
  end
