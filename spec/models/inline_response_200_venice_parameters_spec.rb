...
# Unit tests for SwaggerClient::InlineResponse200VeniceParameters
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse200VeniceParameters' do
  before do
    # run before each test
    @instance = SwaggerClient::InlineResponse200VeniceParameters.new
  end
  ...
  describe 'test an instance of InlineResponse200VeniceParameters' do
    it 'should create an instance of InlineResponse200VeniceParameters' do
      expect(@instance).to be_instance_of(SwaggerClient::InlineResponse200VeniceParameters)
    end
  end
