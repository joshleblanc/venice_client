...
# Unit tests for SwaggerClient::AnyOfModelResponseModelSpecConstraints
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AnyOfModelResponseModelSpecConstraints' do
  before do
    # run before each test
    @instance = SwaggerClient::AnyOfModelResponseModelSpecConstraints.new
  end
  ...
  describe 'test an instance of AnyOfModelResponseModelSpecConstraints' do
    it 'should create an instance of AnyOfModelResponseModelSpecConstraints' do
      expect(@instance).to be_instance_of(SwaggerClient::AnyOfModelResponseModelSpecConstraints)
    end
  end
end
