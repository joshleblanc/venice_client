...
# Unit tests for VeniceClient::InlineResponse2008
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe "InlineResponse2008" do
  before do
    # run before each test
    @instance = VeniceClient::InlineResponse2008.new
  end
  ...
  describe "test an instance of InlineResponse2008" do
    it "should create an instance of InlineResponse2008" do
      expect(@instance).to be_instance_of(VeniceClient::InlineResponse2008)
    end
  end
