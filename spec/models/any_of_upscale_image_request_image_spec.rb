...
# Unit tests for SwaggerClient::AnyOfUpscaleImageRequestImage
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AnyOfUpscaleImageRequestImage' do
  before do
    # run before each test
    @instance = SwaggerClient::AnyOfUpscaleImageRequestImage.new
  end
  ...
  describe 'test an instance of AnyOfUpscaleImageRequestImage' do
    it 'should create an instance of AnyOfUpscaleImageRequestImage' do
      expect(@instance).to be_instance_of(SwaggerClient::AnyOfUpscaleImageRequestImage)
    end
  end
end
