...
# Unit tests for SwaggerClient::InlineResponse200Logprobs
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse200Logprobs' do
  before do
    # run before each test
    @instance = SwaggerClient::InlineResponse200Logprobs.new
  end
  ...
  describe 'test an instance of InlineResponse200Logprobs' do
    it 'should create an instance of InlineResponse200Logprobs' do
      expect(@instance).to be_instance_of(SwaggerClient::InlineResponse200Logprobs)
    end
  end
