...
# Unit tests for SwaggerClient::OneOfChatCompletionRequestResponseFormat
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OneOfChatCompletionRequestResponseFormat' do
  before do
    # run before each test
    @instance = SwaggerClient::OneOfChatCompletionRequestResponseFormat.new
  end
  ...
  describe 'test an instance of OneOfChatCompletionRequestResponseFormat' do
    it 'should create an instance of OneOfChatCompletionRequestResponseFormat' do
      expect(@instance).to be_instance_of(SwaggerClient::OneOfChatCompletionRequestResponseFormat)
    end
  end
end
