...
# Unit tests for VeniceClient::InlineResponse500
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe "InlineResponse500" do
  before do
    # run before each test
    @instance = VeniceClient::InlineResponse500.new
  end
  ...
  describe "test an instance of InlineResponse500" do
    it "should create an instance of InlineResponse500" do
      expect(@instance).to be_instance_of(VeniceClient::InlineResponse500)
    end
  end
