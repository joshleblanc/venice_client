...
# Unit tests for SwaggerClient::BillingUsageRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BillingUsageRequest' do
  before do
    # run before each test
    @instance = SwaggerClient::BillingUsageRequest.new
  end
  ...
  describe 'test an instance of BillingUsageRequest' do
    it 'should create an instance of BillingUsageRequest' do
      expect(@instance).to be_instance_of(SwaggerClient::BillingUsageRequest)
    end
  end
