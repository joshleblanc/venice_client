...
# Unit tests for SwaggerClient::CreateEmbeddingRequestSchema
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateEmbeddingRequestSchema' do
  before do
    # run before each test
    @instance = SwaggerClient::CreateEmbeddingRequestSchema.new
  end
  ...
  describe 'test an instance of CreateEmbeddingRequestSchema' do
    it 'should create an instance of CreateEmbeddingRequestSchema' do
      expect(@instance).to be_instance_of(SwaggerClient::CreateEmbeddingRequestSchema)
    end
  end
