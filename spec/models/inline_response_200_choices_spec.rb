...
# Unit tests for VeniceClient::InlineResponse200Choices
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse200Choices' do
  before do
    # run before each test
    @instance = VeniceClient::InlineResponse200Choices.new
  end
  ...
  describe 'test an instance of InlineResponse200Choices' do
    it 'should create an instance of InlineResponse200Choices' do
      expect(@instance).to be_instance_of(VeniceClient::InlineResponse200Choices)
    end
  end
