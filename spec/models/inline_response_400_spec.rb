...
# Unit tests for VeniceClient::InlineResponse400
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe "InlineResponse400" do
  before do
    # run before each test
    @instance = VeniceClient::InlineResponse400.new
  end
  ...
  describe "test an instance of InlineResponse400" do
    it "should create an instance of InlineResponse400" do
      expect(@instance).to be_instance_of(VeniceClient::InlineResponse400)
    end
  end
