...
# Unit tests for SwaggerClient::BillingUsageResponseData
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BillingUsageResponseData' do
  before do
    # run before each test
    @instance = SwaggerClient::BillingUsageResponseData.new
  end
  ...
  describe 'test an instance of BillingUsageResponseData' do
    it 'should create an instance of BillingUsageResponseData' do
      expect(@instance).to be_instance_of(SwaggerClient::BillingUsageResponseData)
    end
  end
