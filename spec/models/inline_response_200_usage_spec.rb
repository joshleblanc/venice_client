...
# Unit tests for SwaggerClient::InlineResponse200Usage
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse200Usage' do
  before do
    # run before each test
    @instance = SwaggerClient::InlineResponse200Usage.new
  end
  ...
  describe 'test an instance of InlineResponse200Usage' do
    it 'should create an instance of InlineResponse200Usage' do
      expect(@instance).to be_instance_of(SwaggerClient::InlineResponse200Usage)
    end
  end
