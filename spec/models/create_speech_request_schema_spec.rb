...
# Unit tests for SwaggerClient::CreateSpeechRequestSchema
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateSpeechRequestSchema' do
  before do
    # run before each test
    @instance = SwaggerClient::CreateSpeechRequestSchema.new
  end
  ...
  describe 'test an instance of CreateSpeechRequestSchema' do
    it 'should create an instance of CreateSpeechRequestSchema' do
      expect(@instance).to be_instance_of(SwaggerClient::CreateSpeechRequestSchema)
    end
  end
