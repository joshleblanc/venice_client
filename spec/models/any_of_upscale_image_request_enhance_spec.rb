...
# Unit tests for SwaggerClient::AnyOfUpscaleImageRequestEnhance
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AnyOfUpscaleImageRequestEnhance' do
  before do
    # run before each test
    @instance = SwaggerClient::AnyOfUpscaleImageRequestEnhance.new
  end
  ...
  describe 'test an instance of AnyOfUpscaleImageRequestEnhance' do
    it 'should create an instance of AnyOfUpscaleImageRequestEnhance' do
      expect(@instance).to be_instance_of(SwaggerClient::AnyOfUpscaleImageRequestEnhance)
    end
  end
end
