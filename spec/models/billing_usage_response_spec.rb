...
# Unit tests for SwaggerClient::BillingUsageResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BillingUsageResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::BillingUsageResponse.new
  end
  ...
  describe 'test an instance of BillingUsageResponse' do
    it 'should create an instance of BillingUsageResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::BillingUsageResponse)
    end
  end
