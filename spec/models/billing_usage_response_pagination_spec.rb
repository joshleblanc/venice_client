...
# Unit tests for SwaggerClient::BillingUsageResponsePagination
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BillingUsageResponsePagination' do
  before do
    # run before each test
    @instance = SwaggerClient::BillingUsageResponsePagination.new
  end
  ...
  describe 'test an instance of BillingUsageResponsePagination' do
    it 'should create an instance of BillingUsageResponsePagination' do
      expect(@instance).to be_instance_of(SwaggerClient::BillingUsageResponsePagination)
    end
  end
