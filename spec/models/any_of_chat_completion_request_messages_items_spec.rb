...
# Unit tests for SwaggerClient::AnyOfChatCompletionRequestMessagesItems
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AnyOfChatCompletionRequestMessagesItems' do
  before do
    # run before each test
    @instance = SwaggerClient::AnyOfChatCompletionRequestMessagesItems.new
  end
  ...
  describe 'test an instance of AnyOfChatCompletionRequestMessagesItems' do
    it 'should create an instance of AnyOfChatCompletionRequestMessagesItems' do
      expect(@instance).to be_instance_of(SwaggerClient::AnyOfChatCompletionRequestMessagesItems)
    end
  end
end
