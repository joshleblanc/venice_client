...
# Unit tests for SwaggerClient::AnyOfCreateEmbeddingRequestSchemaInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AnyOfCreateEmbeddingRequestSchemaInput' do
  before do
    # run before each test
    @instance = SwaggerClient::AnyOfCreateEmbeddingRequestSchemaInput.new
  end
  ...
  describe 'test an instance of AnyOfCreateEmbeddingRequestSchemaInput' do
    it 'should create an instance of AnyOfCreateEmbeddingRequestSchemaInput' do
      expect(@instance).to be_instance_of(SwaggerClient::AnyOfCreateEmbeddingRequestSchemaInput)
    end
  end
end
